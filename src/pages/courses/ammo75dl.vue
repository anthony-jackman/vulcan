<template>
  ...
  <section id="isap" class="has-background-grey-lighter has-text-grey-dark has-text-centered block">
    ...
    <section id="audience" class="block">
      <h2 class="subtitle is-inline is-bold">Audience: </h2>Personnel requiring a fundamental understanding of Army physical security requirements as prescribed by DoD 5160.68 and AR 190-11. <span class="has-text-weight-bold has-text-danger">NOTE:</span> This course is rated FD3 and not available to International Military Students.
    </section>
  ...
  <section id="crseTopics" class="block">
    ...
    <div class="content">
      <ul>
        ...
        <li>Entry Control</li>
        <li>Storage and Monitoring</li>
        <li>Lock and Key Management</li>
        <li>Perimeter Controls</li>
        <li>Inspections</li>
      </ul>
    </div>
  </section>
