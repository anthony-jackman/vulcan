...
<template>
    <h1 class="title has-text-centered mt-3">AMMO-31-DL Environmental Considerations for Ammunition Personnel (9E-F64/920-F32 (DL))</h1>
    <section id="register" class="buttons columns">
      <!-- <div class="column is-one-third"></div> -->
      <div class="column is-1 is-offset-5">
        <button class="button"><a href='https://www.atrrs.army.mil/atrrscc/courseInfo.aspx?fy=2024&sch=910&crs=9E-F64%2f920-F32+(DL)&crstitle=ENVIRONMENTAL+CONSIDERATIONS+FOR+AMMO+PERS&phase=' target='_blank'>Register for Course</a></button>
      </div>
      <!-- <div class="column is-one-third"></div> -->
    </section>
