<template>
  <h1 class="title has-text-centered mt-3">AMMO-28-DL Army Electrical Explosives Safety (CERT) (4E-F33/645-F17 (DL))</h1>
  <section id="register" class="buttons columns">
    <!-- <div class="column is-one-third"></div> -->
    <div class="column is-1 is-offset-5">
      <button class="button"><a href='https://www.atrrs.army.mil/atrrscc/courseInfo.aspx?fy=2024&sch=910&crs=4E-F33%2f645-F17+(DL)&crstitle=ARMY+ELECTRICAL+EXPLOSIVE+SAFETY+(CERT)&phase=' target='_blank'>Register for Course</a></button>
    </div>
    <!-- <div class="column is-one-third"></div> -->
  </section>
  ...
  <section id="audience" class="block">
    <h2 class="subtitle is-inline is-bold">Audience: </h2>Personnel involved in the design, installation, test, maintenance, and inspection of electrical equipment, static dissipation systems, lightning protection systems, and bonding for Army explosives facilities as prescribed by DoDI 5160.68, AR 385-10, and DA PAM 385-64. <span class="has-text-weight-bold has-text-danger">NOTE:</span> This course is rated FD3 and not available to International Military Students.
  </section>
